<?php
	...
	$HELP_CREATE_TITLE = "Créer un nouveau ticket";
	$HELP_CREATE_SUBJECT = "Sujet";
	$HELP_CREATE_SERVICE = "Service";
	$HELP_CREATE_SERVICE_1 = "Service technique";
	$HELP_CREATE_SERVICE_2 = "Service commercial";
	$HELP_CREATE_SERVICE_3 = "Partenaire & Certifié";
	$HELP_CREATE_SERVICE_4 = "Recrutement";
	$HELP_CREATE_SERVICE_5 = "Autres";
	$HELP_CREATE_MESSAGE = "Message";
	$HELP_CREATE_BUTTON = "Ouvrir le ticket !";


	$HELP_LIST_TITLE = "Vos tickets";
	$HELP_LIST_NEW_BUTTON = "Nouveau ticket";
	$HELP_LIST_1 = "Statut";
	$HELP_LIST_2 = "Service";
	$HELP_LIST_3 = "Sujet";
	$HELP_LIST_4 = "Date de la dernière action";
