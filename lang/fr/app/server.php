<?php
    ...
    $SERVER_MENU_LEVELS = "NIVEAUX";
    $SERVER_MENU_STATS = "STATS";
    $SERVER_MENU_SUBUSER = "SUBUSERS";
    $SERVER_MENU_HISTORY = "HISTORIQUE";
    ...
    $SERVER_HOME_CARD_1 = "Impact";

    $SERVER_HOME_CARD_2 = "Statut";
    $SERVER_HOME_CARD_2_ON = "Online";
    $SERVER_HOME_CARD_2_ERROR = "Erreur";
    $SERVER_HOME_CARD_2_OFF = "Offline";
    ...
    $SERVER_SETTINGS_1 = "Identifiant Discord (ID)";
    $SERVER_SETTINGS_2 = "Nom";
    $SERVER_SETTINGS_3 = "Invitation";
    $SERVER_SETTINGS_4 = "Étiquettes";
    $SERVER_SETTINGS_5 = "Catégorie";
    $SERVER_SETTINGS_6 = "Language";
    $SERVER_SETTINGS_7 = "Avis";
    $SERVER_SETTINGS_8 = "Statistiques publiques";
    $SERVER_SETTINGS_9 = "Méthode de vote";
    $SERVER_SETTINGS_10 = "Statut";
    $SERVER_SETTINGS_11 = "Webhook de vote";
    $SERVER_SETTINGS_12 = "Lien personnalisé";
    $SERVER_SETTINGS_13 = "Description";
    $SERVER_SETTINGS_BUTTON = "Sauvegarder";

    $SERVER_SETTINGS_5_1 = "Communautaire";
    ...
    $SERVER_SETTINGS_9_1 = "Bot & Web (Sécurisé)";
    $SERVER_SETTINGS_9_2 = "Uniquement Web";

    $SERVER_SETTINGS_STATUT_ON = "Activé";
    $SERVER_SETTINGS_STATUT_OFF = "Désactivé";
