<?php
	...
	$S_BUTTON_REVIEW_ALREADY = "Vous avez déjà donner votre avis pour ce serveur ;) !";
	...
	$VOTE_MSG_2 = "<strong>La tentative est honnorable, mais l'échec est puissant !</strong>";
	$VOTE_MSG_3 = "<strong>Avez-vous oublié des neuronnes lors de votre réveil ?</strong> Prennez un bon café, ça devrait vous réveillez !";
	$VOTE_MSG_4 = "<strong>Merci pour votre avis !</strong> Vous avez contribuer à votre évoluer notre serveur, merci !";
	...
	$S_CARD_QUEST_ENDED = "Wow.. Vous avez terminé toutes les quêtes ..! Vous êtes si rapide ... Attendez un peu pour avoir de nouvelle quête: D";
	...
	$S_CARD_VOTERS_T_VOTES = "Votes Global";
	...
	$S_MODAL_PSEUDO_TITLE = "Choisi un pseudo !";
