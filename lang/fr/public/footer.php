<?php
	...
	$FOOTER_DESCRIPTION = "DiscordTop.org vous aide depuis 2018 à construire et mettre en avant votre communauté ! Vous n'avez toujours pas inscrit votre serveur ? N'attendez plus et propulsez votre serveur !";
