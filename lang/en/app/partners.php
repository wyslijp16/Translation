<?php
	...
	$PARTNERS_TITLE = "Partners Settings";
	...
	$PARTNERS_SETTINGS_DESC = "Explain";
	$PARTNERS_SETTINGS_SUBDESC = "Félicitation, vous êtes désormais un partenaire de DiscordTop !<br>Votre compte est désormais partenaire, vous pouvez récupérer votre lien d'affilié dans la page d'affiliation et la partagée. Vous possédez des avantages considérables, en tant que partenaire vous avez accès à l'abonnement Developer gratuitement, vous pouvez également retirer vos coins en demandant un virement PayPal ou créer des codes cadeaux pour votre communauté !<br><br>De cette page, vous pouvez également configurer votre logo et votre lien qui sera affiché dans le pied de page de notre site.";
